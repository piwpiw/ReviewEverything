        ...
        <div className="group relative border border-slate-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 bg-white flex flex-col transition-all duration-500 ease-in-out cursor-pointer z-0 hover:z-10">
            <div className="relative h-60 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-2">
                    <span className="bg-slate-900/90 backdrop-blur-md text-white text-[10px] font-black px-2.5 py-1.5 rounded-lg shadow-xl tracking-tighter uppercase border border-white/20 self-start">
                        {campaign.platform.name}
                    </span>
                    {isLowComp && (
                        <span className="bg-gradient-to-br from-amber-400 via-orange-500 to-rose-500 text-white text-[10px] font-black px-2.5 py-1.5 rounded-lg shadow-xl animate-pulse flex items-center gap-1 border border-white/20 self-start">
