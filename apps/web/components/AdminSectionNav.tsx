...
import { Activity, ChartLine, Layers, Play, Server } from "lucide-react";
import { useEffect, useState } from "react";
import { usePathname } from "next/navigation";

type AdminSection = "overview" | "platforms" | "history" | "analysis" | "system";
...
const MENU_ITEMS: MenuItem[] = [
  { key: "overview", href: "/admin#overview", label: "운영 개요", icon: Activity, anchor: "#overview" },
  ...
  { key: "system", href: "/system", label: "운영 시스템", icon: Server },
];
