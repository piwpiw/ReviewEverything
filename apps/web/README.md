...
## ðŸš€ System Architecture & Agent Index
...
### ðŸ§  Agent Quick Index (Fast Onboarding)
...
## ðŸš€ Key Technical Features (Beta)
...
### CI / Deployment
- GitHub Actions workflow: .github/workflows/ci.yml(main ºê·£Ä¡ push/pull_request ±âÁØ)
- µ¿ÀÛ: pps/web¿¡¼­ 
pm ci ÈÄ 
pm run test`n- Å×½ºÆ® °á°ú´Â pps/web/test_output.txtÀÇ ÃÖ½Å ½ÇÇà ·Î±×·Î °»½Å
